...
const LoginPage = () => {
  ...
  useEffect(() => {
    const checkServerStatus = async () => {
      try {
        await axios.get(
          "https://compra-de-cafe-backend.onrender.com/api/notifi"
        );
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://compra-de-cafe-backend.onrender.com/api/auth/login",
        {
          user,
          password,
  ...
  const handleRegister = async (e) => {
    ...
    try {
      await axios.post(
        "https://compra-de-cafe-backend.onrender.com/api/auth/register",
        { user, password, email }
      );
